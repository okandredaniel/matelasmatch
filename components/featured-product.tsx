    ...
    <section className="py-20 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-sans text-3xl md:text-4xl font-bold text-foreground mb-4">Produit Vedette</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Notre sélection coup de cœur : le matelas le plus apprécié par nos utilisateurs ce mois-ci.
          </p>
        </div>
              ...
              <CardContent className="p-8 lg:p-12 flex flex-col justify-center">
                <div className="mb-6">
                  ...
                  <p className="text-slate-600 text-lg mb-4">
                    Le matelas le plus plébiscité par nos utilisateurs. Mousse à mémoire de forme haute densité avec
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xl text-slate-400 line-through">799€</span>
                    </div>
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-slate-700">Mousse à mémoire de forme haute densité</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full"></div>
                      <span className="text-slate-700">Régulation thermique avancée</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full"></div>
                      <span className="text-slate-700">Support optimal de la colonne vertébrale</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full"></div>
                ...
                <Button
                  ...
                  asChild
                >
                  <a href="https://amazon.fr/matelas-confort-premium" target="_blank" rel="noopener noreferrer">
                    <div className="flex items-center space-x-3">
